...
$config = array(
	...
	'user_put' => array(
			array( 'field'=>'email', 'label'=>'correo electronico','rules'=>'trim|required|valid_email' ),
			array( 'field'=>'first_name', 'label'=>'nombre','rules'=>'trim|required|min_length[2]|max_length[255]' )
	),
